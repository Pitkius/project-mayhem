...
-- FIVEMPROJEKTAS hard lock:
-- allow character creation/player model usage only on freemode peds.
Config.WomanPlayerModels = { 'mp_f_freemode_01' }
Config.ManPlayerModels = { 'mp_m_freemode_01' }
