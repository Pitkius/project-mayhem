...
local Vehicles = {
    ...
    --- Motorcycles (8)
    { model = 'akuma',           name = 'Akuma',                         brand = 'Dinka',           price = 38500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'avarus',          name = 'Avarus',                        brand = 'LCC',             price = 13000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'bagger',          name = 'Bagger',                        brand = 'WMC',             price = 9000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'bati',            name = 'Bati 801',                      brand = 'Pegassi',         price = 15500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'bati2',           name = 'Bati 801RR',                    brand = 'Pegassi',         price = 12500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'bf400',           name = 'BF400',                         brand = 'Nagasaki',        price = 14500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'carbonrs',        name = 'Carbon RS',                     brand = 'Nagasaki',        price = 14500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'chimera',         name = 'Chimera',                       brand = 'Nagasaki',        price = 13500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'cliffhanger',     name = 'Cliffhanger',                   brand = 'Western',         price = 18500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'daemon',          name = 'Daemon',                        brand = 'WMC',             price = 9000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'daemon2',         name = 'Daemon Custom',                 brand = 'Western',         price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'defiler',         name = 'Defiler',                       brand = 'Shitzu',          price = 19500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'deathbike',       name = 'Deathbike Apocalypse',          brand = 'Deathbike',       price = 19500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'deathbike2',      name = 'Deathbike Future Shock',        brand = 'Deathbike',       price = 19500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'deathbike3',      name = 'Deathbike Nightmare',           brand = 'Deathbike',       price = 19500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'diablous',        name = 'Diablous',                      brand = 'Principe',        price = 19500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'diablous2',       name = 'Diablous Custom',               brand = 'Principe',        price = 24500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'double',          name = 'Double-T',                      brand = 'Dinka',           price = 18000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'enduro',          name = 'Enduro',                        brand = 'Dinka',           price = 3300,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'esskey',          name = 'Esskey',                        brand = 'Pegassi',         price = 8000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'faggio',          name = 'Faggio Sport',                  brand = 'Pegassi',         price = 1200,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'faggio2',         name = 'Faggio',                        brand = 'Pegassi',         price = 1100,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'faggio3',         name = 'Faggio Mod',                    brand = 'Pegassi',         price = 1500,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'fcr',             name = 'FCR 1000',                      brand = 'Pegassi',         price = 3000,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'fcr2',            name = 'FCR 1000 Custom',               brand = 'Pegassi',         price = 12500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'gargoyle',        name = 'Gargoyle',                      brand = 'Western',         price = 21000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'hakuchou',        name = 'Hakuchou',                      brand = 'Shitzu',          price = 11000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'hakuchou2',       name = 'Hakuchou Drag',                 brand = 'Shitzu',          price = 29500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'hexer',           name = 'Hexer',                         brand = 'LCC',             price = 10500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'innovation',      name = 'Innovation',                    brand = 'LLC',             price = 22000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'lectro',          name = 'Lectro',                        brand = 'Principe',        price = 18000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'manchez',         name = 'Manchez',                       brand = 'Maibatsu',        price = 5000,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'nemesis',         name = 'Nemesis',                       brand = 'Principe',        price = 13000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'nightblade',      name = 'Nightblade',                    brand = 'WMC',             price = 15000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'oppressor',       name = 'Oppressor',                     brand = 'Pegassi',         price = 9999999, category = 'motorcycles',    type = 'bike',       shop = 'luxury' },
    { model = 'pcj',             name = 'PCJ-600',                       brand = 'Shitzu',          price = 10000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'ratbike',         name = 'Rat Bike',                      brand = 'Western',         price = 1800,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'ruffian',         name = 'Ruffian',                       brand = 'Pegassi',         price = 16500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'rrocket',         name = 'Rampant Rocket',                brand = 'Western',         price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'sanchez',         name = 'Sanchez Livery',                brand = 'Maibatsu',        price = 3200,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'sanchez2',        name = 'Sanchez',                       brand = 'Maibatsu',        price = 3200,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'sanctus',         name = 'Sanctus',                       brand = 'LCC',             price = 23000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'shotaro',         name = 'Shotaro',                       brand = 'Nagasaki',        price = 224000,  category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'sovereign',       name = 'Sovereign',                     brand = 'WMC',             price = 4800,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'stryder',         name = 'Stryder',                       brand = 'Nagasaki',        price = 35000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'thrust',          name = 'Thrust',                        brand = 'Dinka',           price = 14500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'vader',           name = 'Vader',                         brand = 'Shitzu',          price = 4300,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'vindicator',      name = 'Vindicator',                    brand = 'Dinka',           price = 12500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'vortex',          name = 'Vortex',                        brand = 'Pegassi',         price = 20000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'wolfsbane',       name = 'Wolfsbane',                     brand = 'Western',         price = 9000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'zombiea',         name = 'Zombie Bobber',                 brand = 'Western',         price = 18000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'zombieb',         name = 'Zombie Chopper',                brand = 'Western',         price = 17500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'manchez2',        name = 'Manchez Scout',                 brand = 'Maibatsu',        price = 9000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'shinobi',         name = 'Shinobi',                       brand = 'Nagasaki',        price = 16500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'reever',          name = 'Reever',                        brand = 'Western',         price = 16500,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'manchez3',        name = 'Manchez Scout Classic',         brand = 'Maibatsu',        price = 10000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'powersurge',      name = 'Powersurge',                    brand = 'Western',         price = 4200,    category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    { model = 'pizzaboy',        name = 'Pizza Boy',                     brand = 'Pegassi',         price = 35000,   category = 'motorcycles',    type = 'bike',       shop = 'pdm' },
    --- Off-Road (9)
    ...
    --- Money Fronts DLC (build 3570)
    { model = 'cheetah3',        name = 'LSCM Cheetah Classic',          brand = 'Grotti',          price = 245000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    { model = 'driftchavosv6',   name = 'Chavos V6',                     brand = 'Dinka',           price = 95000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'driftdominator10', name = 'Dominator FX',                 brand = 'Vapid',           price = 185000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'driftgauntlet4',  name = 'Gauntlet Hellfire',             brand = 'Bravado',         price = 195000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'drifthardy',      name = 'Hardy (Drift)',                 brand = 'Annis',           price = 88000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'driftl352',       name = 'Drift Walton L35',              brand = 'Declasse',        price = 72000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = 'everon3',         name = 'Everon RS',                     brand = 'Karin',           price = 168000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    { model = 'hardy',           name = 'Hardy',                         brand = 'Annis',           price = 82000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'l352',            name = 'Walton L35',                    brand = 'Declasse',        price = 68000,   category = 'offroad',        type = 'automobile', shop = 'pdm' },
    { model = 'minimus',         name = 'Minimus',                       brand = 'Annis',           price = 92000,   category = 'sedans',         type = 'automobile', shop = 'pdm' },
    { model = 'rapidgt4',        name = 'Rapid GT X',                    brand = 'Dewbauchee',      price = 215000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'sentinel5',       name = 'Sentinel GTS',                  brand = 'Übermacht',       price = 198000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'suzume',          name = 'Suzume',                        brand = 'Överflöd',        price = 2850000, category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'tampa4',          name = 'Tampa GT',                      brand = 'Declasse',        price = 142000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'woodlander',      name = 'Woodlander',                    brand = 'Karin',           price = 118000,  category = 'suvs',           type = 'automobile', shop = 'pdm' },
    --- A Safehouse in the Hills DLC (build 3717)
    { model = 'astrale',         name = 'Astrale',                       brand = 'Pfister',         price = 265000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    { model = 'driftdominator9', name = 'Dominator GT (Drift)',          brand = 'Vapid',           price = 228000,  category = 'muscle',         type = 'automobile', shop = 'pdm' },
    { model = 'driftkeitora',    name = 'Keitora (Drift)',               brand = 'Shitzu',          price = 42000,   category = 'utility',        type = 'automobile', shop = 'pdm' },
    { model = 'driftrt3000',     name = 'RT3000 (Drift)',                brand = 'Dinka',           price = 165000,  category = 'sports',         type = 'automobile', shop = 'luxury' },
    { model = 'driftsentinel2',  name = 'Sentinel XS (Drift)',           brand = 'Übermacht',       price = 155000,  category = 'coupes',         type = 'automobile', shop = 'luxury' },
    { model = 'fmj2',            name = 'FMJ MK V',                      brand = 'Vapid',           price = 1850000, category = 'super',          type = 'automobile', shop = 'luxury' },
    { model = 'gt750',           name = 'GT750',                         brand = 'Grotti',          price = 198000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    { model = 'itali2',          name = 'Itali Classic',                 brand = 'Grotti',          price = 235000,  category = 'sportsclassics', type = 'automobile', shop = 'luxury' },
    { model = 'keitora',         name = 'Keitora',                       brand = 'Shitzu',          price = 38000,   category = 'utility',        type = 'automobile', shop = 'pdm' },
