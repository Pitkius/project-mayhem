...
local function spawnDebugVendor()
    ...
    exports['qb-target']:AddTargetEntity(debugPed, {
        options = {
            {
                type = 'client',
                event = 'mrp_mechanic:client:debugOpenSupplyShop',
                icon = 'fas fa-brush',
                label = 'Žaliavų test shop',
            },
            {
                type = 'client',
                event = 'mrp_mechanic:client:debugOpenPickaxeShop',
                icon = 'fas fa-stream',
...
RegisterNetEvent('mrp_mechanic:client:debugOpenSupplyShop', function()
    TriggerServerEvent('mrp_mechanic:server:debugOpenSupplyShop')
end)

RegisterNetEvent('mrp_mechanic:client:debugOpenPickaxeShop', function()
    TriggerServerEvent('mrp_mechanic:server:debugOpenPickaxeShop')
end)
