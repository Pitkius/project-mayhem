...
RegisterNetEvent('fivempro_mechanic:server:requestDoorsSync', function()
    TriggerClientEvent('fivempro_mechanic:client:syncDoors', source, MechDoorLocked)
end)

RegisterNetEvent('fivempro_mechanic:server:toggleDoorGroup', function(groupId)
    local src = source
    ...
    TriggerClientEvent('fivempro_mechanic:client:setDoorState', -1, groupId, MechDoorLocked[groupId])
    TriggerClientEvent(
        'QBCore:Notify',
        src,
