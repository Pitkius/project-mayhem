...
local function tryToggleNearestDoor(pcoords)
    ...
    lastToggle = now
    TriggerServerEvent('fivempro_mechanic:server:toggleDoorGroup', closestHit.gid)
end
        ...
        options = {
            {
                ...
                action = function()
                    TriggerServerEvent('fivempro_mechanic:server:toggleDoorGroup', groupId)
                end,
...
RegisterNetEvent('fivempro_mechanic:client:syncDoors', function(state)
...
RegisterNetEvent('fivempro_mechanic:client:setDoorState', function(id, locked)
...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    Wait(2000)
    TriggerServerEvent('fivempro_mechanic:server:requestDoorsSync')
end)
