...
Config.PoliceDealership = {
    ...
    vehicles = {
        ...
        { model = 'mrpd11', name = 'MRPD 11 — Ford', brand = 'Ford', category = 'marked', price = 30000, minGrade = 2, shopEnabled = true },
        ...
        -- mrpd26 removed (duplicate of mrpd11)
        ...
        { model = 'mrpd16', name = 'MRPD 16 — Skoda Hatch', brand = 'Skoda', category = 'marked', price = 34000, minGrade = 0, shopEnabled = true },
        { model = 'mrpd23', name = 'MRPD 23 — Skoda Estate', brand = 'Skoda', category = 'marked', price = 34500, minGrade = 0, shopEnabled = true },
