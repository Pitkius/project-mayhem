...
local reasonLabels = {
    ...
    corpse_already_looted = 'Šis NPC jau apiplėštas.',
    corpse_gone = 'Kūnas dingęs.',
    corpse_too_far = 'Esi per toli nuo kūno.',
    npc_still_alive = 'NPC dar gyvas.',
    invalid_corpse = 'Netinkamas taikinys.',
    encounter_inactive = 'Šiuo metu nėra priešų bangos.',
    loot_failed = 'Nepavyko paimti grobio.',
