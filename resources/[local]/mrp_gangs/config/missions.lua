...
-- Category thumbnail keys (files under html/images/missions/*.png).
Config.MissionImages = {
    raid = 'raid.png',
    search = 'search.png',
    defence = 'defence.png',
    rescue = 'rescue.png',
...
local function add(id, data)
    ...
    data.image = data.image or 'raid'
    Config.Missions[id] = data
end

local indoorRaid = {
    { type = 'approach', label = 'Atvyk į operacijos vietą', minSeconds = 3 },
    { type = 'breach', label = 'Įveik apsaugotą įėjimą', location = 'site', durationMs = 7000 },
    { type = 'enter', label = 'Eik į vidų', minSeconds = 1 },
    ...
    { type = 'exit', label = 'Palik zoną', minSeconds = 2 },
    { type = 'extract', label = 'Pristatyk krovinį kontaktui', minSeconds = 10 },
}

local indoorSearch = {
    { type = 'approach', label = 'Atvyk nepastebėtas', minSeconds = 3 },
    ...
    { type = 'exit', label = 'Pasitrauk iš zonos', minSeconds = 2 },
    { type = 'extract', label = 'Perduok radinį', minSeconds = 10 },
}

local indoorDefence = {
    { type = 'approach', label = 'Atvyk į gynybos vietą', minSeconds = 3 },
    { type = 'enter', label = 'Užimk poziciją', minSeconds = 1 },
...
local indoorRescue = {
    { type = 'approach', label = 'Atvyk į taikinio vietą', minSeconds = 3 },
...
local indoorSabotage = {
    { type = 'approach', label = 'Atvyk į objekto vietą', minSeconds = 3 },
    { type = 'breach', label = 'Įveik apsaugą', location = 'site', durationMs = 7000 },
    { type = 'enter', label = 'Eik į objektą', minSeconds = 1 },
    { type = 'eliminate', label = 'Neutralizuok apsaugą', encounter = 'raid' },
...
local outdoorDelivery = {
    { type = 'approach', label = 'Atvyk į paėmimo vietą', minSeconds = 3 },
...
local outdoorEscort = {
    { type = 'approach', label = 'Susitik su kontaktu', minSeconds = 3 },
...
local raceContract = {
    { type = 'approach', label = 'Atvyk į starto vietą', minSeconds = 3 },
...
add('warehouse_break_in', {
    ...
    sitePool = 'industrial', compound = 'warehouse_yard', image = 'raid',
    baseReward = 4200, baseReputation = 12, phases = indoorRaid,
})
add('missing_cargo', {
    label = 'Missing Cargo',
    category = 'universal',
    description = 'Surask dingusį krovinį pagal kelias patikros vietas.',
    sitePool = 'docks', compound = 'warehouse_yard', image = 'docks',
    baseReward = 3900, baseReputation = 11, phases = indoorSearch,
})
add('contact_extraction', {
    label = 'Contact Extraction',
    category = 'universal',
    description = 'Ištrauk kontaktą iš priešiškos bazės ir saugiai pasitrauk.',
    sitePool = 'city', compound = 'club_lot', image = 'rescue',
    baseReward = 4600, baseReputation = 14, phases = indoorRaid,
})
add('secret_meeting', {
    label = 'Secret Meeting',
    category = 'universal',
    description = 'Apsaugok slaptą sandorį nuo išdavystės.',
    sitePool = 'rural', image = 'escort',
    baseReward = 4000, baseReputation = 12, phases = outdoorEscort,
})
add('emergency_cash_move', {
    label = 'Emergency Cash Move',
    category = 'universal',
    description = 'Perkelk pinigus prieš prasidedant reidui.',
    sitePool = 'city', image = 'delivery',
    baseReward = 4400, baseReputation = 13, phases = outdoorDelivery,
})
...
add('street_trap_house_defence', {
    ...
    sitePool = 'city', compound = 'street_stash', image = 'defence',
    baseReward = 4300, baseReputation = 15, phases = indoorDefence,
})
add('street_stash_house_raid', {
    label = 'Stash House Raid',
    category = 'street', gangTypes = { street = true },
    description = 'Rask konkurentų stash ir išnešk įrodymus.',
    sitePool = 'industrial', compound = 'street_stash', image = 'search',
    baseReward = 4500, baseReputation = 16, phases = indoorSearch,
})
add('street_debt_collection', {
    label = 'Debt Collection',
    category = 'street', gangTypes = { street = true },
    description = 'Surask skolininką ir paimk sutartą paketą.',
    sitePool = 'city', compound = 'street_stash', image = 'search',
    baseReward = 3700, baseReputation = 13, phases = indoorSearch,
})
add('street_hostage_rescue', {
    label = 'Block Hostage',
    category = 'street', gangTypes = { street = true },
    description = 'Išlaisvink pagrobtą gaujos kontaktą.',
    sitePool = 'industrial', compound = 'warehouse_yard', image = 'rescue',
    baseReward = 4900, baseReputation = 18, phases = indoorRescue,
})
add('street_missing_package', {
    ...
    sitePool = 'city', image = 'delivery',
    baseReward = 3800, baseReputation = 14, phases = outdoorDelivery,
})
...
add('cartel_lab_seizure', {
    ...
    sitePool = 'rural', compound = 'lab_yard', image = 'lab',
    baseReward = 5600, baseReputation = 20, phases = indoorRaid,
})
add('cartel_lab_demolition', {
    label = 'Lab Demolition',
    category = 'cartel', gangTypes = { cartel = true },
    description = 'Neutralizuok apsaugą ir paruošk laboratoriją sunaikinimui.',
    sitePool = 'industrial', compound = 'lab_yard', image = 'sabotage',
    baseReward = 5400, baseReputation = 19, phases = indoorSabotage,
})
add('cartel_bulk_shipment', {
    label = 'Bulk Shipment',
    category = 'cartel', gangTypes = { cartel = true },
    description = 'Apsaugok didelę kontrabandos siuntą.',
    sitePool = 'docks', image = 'docks',
    baseReward = 5800, baseReputation = 21, phases = outdoorEscort,
})
add('cartel_chemist_extraction', {
    ...
    sitePool = 'rural', compound = 'lab_yard', image = 'lab',
    baseReward = 6000, baseReputation = 22, phases = indoorRescue,
})
add('cartel_boat_landing', {
    ...
    sitePool = 'docks', image = 'docks',
    baseReward = 5200, baseReputation = 18, phases = outdoorDelivery,
})
...
add('mafia_protection_collection', {
    ...
    sitePool = 'city', image = 'delivery',
    baseReward = 4400, baseReputation = 15, phases = outdoorDelivery,
})
add('mafia_laundering_ledger', {
    label = 'Laundering Ledger',
    category = 'mafia', gangTypes = { mafia = true },
    description = 'Pakeisk pinigų plovimo dokumentus saugomame biure.',
    sitePool = 'city', compound = 'club_lot', image = 'search',
    baseReward = 5000, baseReputation = 18, phases = indoorSearch,
})
add('mafia_vip_protection', {
    label = 'VIP Protection',
    category = 'mafia', gangTypes = { mafia = true },
    description = 'Apsaugok svarbų kontaktą sandorio metu.',
    sitePool = 'city', image = 'escort',
    baseReward = 5200, baseReputation = 19, phases = outdoorEscort,
})
add('mafia_blackmail_archive', {
    label = 'Blackmail Archive',
    category = 'mafia', gangTypes = { mafia = true },
    description = 'Pavok kompromituojančius dokumentus.',
    sitePool = 'city', compound = 'club_lot', image = 'clubhouse',
    baseReward = 5100, baseReputation = 19, phases = indoorSearch,
})
add('mafia_armored_cash_pickup', {
    label = 'Armored Cash Pickup',
    category = 'mafia', gangTypes = { mafia = true },
    description = 'Perimk grynųjų transportą ir pristatyk į safe point.',
    sitePool = 'industrial', image = 'delivery',
    baseReward = 5500, baseReputation = 20, phases = outdoorDelivery,
})
...
add('biker_lost_motorcycle', {
    ...
    sitePool = 'vehicle', vehicleModel = 'daemon', image = 'racing',
    baseReward = 4100, baseReputation = 15, phases = raceContract,
})
add('biker_custom_parts', {
    label = 'Custom Parts Run',
    category = 'biker', gangTypes = { biker = true },
    description = 'Paimk retas dalis iš saugomo garažo.',
    sitePool = 'industrial', compound = 'garage_lot', image = 'hangar',
    baseReward = 4700, baseReputation = 17, phases = indoorRaid,
})
add('biker_clubhouse_defence', {
    label = 'Clubhouse Defence',
    category = 'biker', gangTypes = { biker = true },
    description = 'Atlaikyk puolimą ir evakuok klubo dokumentus.',
    sitePool = 'rural', compound = 'club_lot', image = 'clubhouse',
    baseReward = 5000, baseReputation = 19, phases = indoorDefence,
})
add('biker_truck_hijack', {
    ...
    sitePool = 'industrial', image = 'delivery',
    baseReward = 4900, baseReputation = 18, phases = outdoorDelivery,
})
...
add('racing_luxury_order', {
    ...
    sitePool = 'vehicle', vehicleModel = 'tailgater2', image = 'racing',
    baseReward = 4800, baseReputation = 17, phases = raceContract,
})
add('racing_multi_car_boost', {
    label = 'Multi-Car Boost',
    category = 'racing', gangTypes = { racing = true },
    description = 'Sinchronizuotai paruošk ir išgabenk automobilių užsakymą.',
    sitePool = 'vehicle', vehicleModel = 'sultan2', image = 'racing',
    baseReward = 5400, baseReputation = 20, phases = raceContract,
})
add('racing_illegal_race', {
    label = 'Illegal Race',
    category = 'racing', gangTypes = { racing = true },
    description = 'Įveik nelegalų kontrakto maršrutą.',
    sitePool = 'vehicle', vehicleModel = 'elegy2', image = 'racing',
    baseReward = 4400, baseReputation = 16, phases = raceContract,
})
add('racing_rare_parts', {
    label = 'Rare Parts',
    category = 'racing', gangTypes = { racing = true },
    description = 'Paimk retas dalis iš saugomo garažo.',
    sitePool = 'hangars', compound = 'hangar_apron', image = 'hangar',
    baseReward = 4700, baseReputation = 17, phases = indoorSearch,
})
add('racing_tracker_removal', {
    label = 'Tracker Removal',
    category = 'racing', gangTypes = { racing = true },
    description = 'Pervežk automobilį per jammer maršrutą ir pristatyk.',
    sitePool = 'vehicle', vehicleModel = 'jester', image = 'racing',
    baseReward = 5000, baseReputation = 18, phases = raceContract,
})
