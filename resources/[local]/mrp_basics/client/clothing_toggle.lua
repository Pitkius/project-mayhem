...
local function canToggleClothing()
    ...
    if GetResourceState('mrp_charcreator') == 'started' then
        local ok, inCreator = pcall(function()
            return exports['mrp_charcreator']:IsInCreator()
        end)
...
RegisterNetEvent('mrp_basics:client:toggleClothing', function(slotKey)
...
RegisterNetEvent('mrp_basics:client:openClothingMenu', openClothingMenu)

RegisterNetEvent('mrp_basics:client:toggleClothingByCommand', function(commandName)
