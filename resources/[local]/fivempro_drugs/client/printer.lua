...
local function openPrintMenu(printerId)
    ...
    QBCore.Functions.TriggerCallback('fivempro_drugs:server:getPrinterMenu', function(rows)
            ...
            menu[#menu + 1] = {
                ...
                params = {
                    ...
                    event = function()
                        ...
                        TriggerServerEvent('fivempro_drugs:server:startPrinterCraft', printerId, row.id)
                    end,
                },
            }
        end
            ...
            exports['qb-target']:AddTargetEntity(obj, {
                options = {
                    ...
                    },
                    {
                        ...
                        action = function()
                            TriggerServerEvent('fivempro_drugs:server:pickupPrinter', id)
                        end,
                    },
                },
...
RegisterNetEvent('fivempro_drugs:client:syncPrinters', function(list)
...
RegisterNetEvent('fivempro_drugs:client:startPlacePrinter', function()
    ...
    CreateThread(function()
        ...
        while placing do
            ...
            elseif IsControlJustPressed(0, 38) then
                ...
                placing = false
                TriggerServerEvent('fivempro_drugs:server:placePrinter', fc.x, fc.y, fc.z, fh)
            end
        end
...
RegisterNetEvent('fivempro_drugs:client:printerCraftStarted', function(printerId, productId, timeMs)
    if printing then return end
    printing = true
    ...
    DrugProgress.run('fivempro_3d_print', label, duration, false, true, {
        ...
        printing = false
        TriggerServerEvent('fivempro_drugs:server:cancelPrinterCraft')
    end)
end)
