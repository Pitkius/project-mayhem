...
CreateThread(function()
    ...
    exports['qb-target']:AddBoxZone('mrp_motel_public_stash', st.coords, st.length or 1.6, st.width or 1.6, {
        name = 'mrp_motel_public_stash',
        ...
        options = {
            {
                type = 'client',
                event = 'mrp_motel:client:openPublicStash',
