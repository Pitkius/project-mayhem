...
local function openCraftUi(stationKey)
    ...
    QBCore.Functions.TriggerCallback('fivempro_ltpd:server:getPdCraftUi', function(data)
...
RegisterNUICallback('pdCraftStart', function(data, cb)
    ...
    runCraftProgress(duration, label, function()
        ...
        crafting = false
        QBCore.Functions.TriggerCallback('fivempro_ltpd:server:getPdCraftUi', function(res)
