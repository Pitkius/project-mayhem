...
QBCore.Functions.CreateCallback('fivempro_weather:server:getForecast', function(_, cb, regionId)
...
QBCore.Functions.CreateCallback('fivempro_weather:server:getRegions', function(_, cb)
    local regions = {}
    for _, r in ipairs(weatherCfg().Regions or {}) do
        regions[#regions + 1] = {
            id = r.id,
