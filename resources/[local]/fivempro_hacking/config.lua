...
Config.HackProfiles = {
    ...
    fleeca_legion = { mode = 'sequence', steps = 4, timeMs = 16000, grid = 4, flashMs = 480 },
    fleeca_greatocean = { mode = 'reverse', steps = 5, timeMs = 15000, grid = 4, flashMs = 440 },
    fleeca_hawick = { mode = 'pairs', steps = 5, timeMs = 14500, grid = 4, flashMs = 420 },
    fleeca_delperro = { mode = 'code', steps = 5, timeMs = 14000, grid = 4, flashMs = 400 },
    fleeca_route68 = { mode = 'sequence', steps = 6, timeMs = 13500, grid = 4, flashMs = 380 },
