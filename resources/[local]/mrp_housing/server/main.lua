...
MySQL.ready(function()
    ...
    print(('[^2mrp_housing^7] Loaded %s property owners'):format(#rows))
end)
...
QBCore.Functions.CreateCallback('mrp_housing:server:purchase', function(src, cb, propertyId, interiorKey)
