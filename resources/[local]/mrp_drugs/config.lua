...
--- Žolės džiovinimas (Davis). Cayo pakavimas vyksta tik prie asmeninio stalo.
Config.WeedCayoLab = {
    blip = {
        enabled = true,
...
Config.WorldSiteIndex = {
    ...
    -- L2 laboratorijos
    { id = 'weed_dry',           category = 'lab',     label = 'Žolės džiovinimas',             coords = '1144.58, -1661.02, 36.61',   desc = 'Weed process — Davis' },
