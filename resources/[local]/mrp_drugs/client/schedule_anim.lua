...
local MODE_ANIMS = {
    ...
    meth_crystal = { dict = 'anim@amb@business@coc@coc_unpack_cut_left@', clip = 'coke_cut_v1_coccutter', prop = nil },
    ...
    heroin_cook = { dict = 'amb@world_human_stand_fire@male@idle_a', clip = 'idle_a', prop = nil },
    heroin_fold = { dict = 'mp_common', clip = 'givetake1_a', prop = 'prop_meth_bag_01' },
    meth_crush_pack = { dict = 'anim@amb@business@coc@coc_unpack_cut_left@', clip = 'coke_cut_v1_coccutter', prop = nil },
    ...
    cocaine_wash = { dict = 'amb@world_human_maid_clean@', clip = 'base', prop = 'prop_sponge_01' },
    cocaine_brick = { dict = 'mp_common', clip = 'givetake1_a', prop = 'prop_meth_bag_01' },
