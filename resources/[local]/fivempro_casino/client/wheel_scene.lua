...
RegisterNetEvent('fivempro_casino:client:jackpotCarUpdated', function(data)
    jackpotData = data
...
CreateThread(function()
    ...
    QBCore.Functions.TriggerCallback('fivempro_casino:server:getJackpotCar', function(data)
        jackpotData = data
    end)
end)
