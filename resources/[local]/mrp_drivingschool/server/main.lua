...
QBCore.Functions.CreateCallback('mrp_drivingschool:server:getLicenceStatus', function(source, cb)
...
QBCore.Functions.CreateCallback('mrp_drivingschool:server:canStartPractical', function(source, cb, category)
...
QBCore.Functions.CreateCallback('mrp_drivingschool:server:startTheory', function(source, cb, category)
    local src = source
...
QBCore.Functions.CreateCallback('mrp_drivingschool:server:submitTheoryAnswer', function(source, cb, sessionId, chosen)
    local src = source
...
RegisterNetEvent('mrp_drivingschool:server:practicalResult', function(category, passed)
    local src = source
...
QBCore.Functions.CreateCallback('mrp_drivingschool:server:getLicenseCard', function(source, cb)
    local Player = QBCore.Functions.GetPlayer(source)
