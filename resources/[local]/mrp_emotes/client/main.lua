...
RegisterCommand('+mrp_emotes_open', function()
    toggleMenu()
end, false)
RegisterCommand('-mrp_emotes_open', function() end, false)
RegisterKeyMapping('+mrp_emotes_open', 'Animacijų meniu (F3)', 'keyboard', Config.OpenKey or 'F3')
...
RegisterNetEvent('mrp_emotes:client:forceClose', function()
    closeMenu()
end)
