...
Config.BurgerNpc.menu = {
    ...
    { id = 'cheese',   label = 'Sūrio burgeris',                     items = { burger_cheese = 1 } },
    { id = 'bacon',    label = 'Šoninės burgeris',                   items = { burger_bacon = 1 } },
    { id = 'bbq',      label = 'BBQ burgeris',                       items = { burger_bbq = 1 } },
    { id = 'salad',    label = 'Salotų burgeris',                    items = { burger_salad = 1 } },
    ...
    { id = 'combo_bbq', label = 'BBQ meniu',                         items = { burger_bbq = 1, burger_fries = 1, burger_softdrink = 1 } },
    { id = 'meal',     label = 'Burgerio meniu (box)',               items = { burger_meal = 1 } },
...
Config.BurgerNpc.voice = {
    ...
    lines = {
        ...
        cheese = 'Sūrio burgerį, prašau.',
        bacon = 'Šoninės burgerį!',
        bbq = 'BBQ burgerį, ačiū.',
        salad = 'Salotų burgerį, lengvesnį.',
        combo1 = 'Burgerį su bulvytėmis.',
        combo2 = 'Burgerį, bulvytes ir didelį gėrimą.',
        combo_bbq = 'BBQ meniu su bulvytėmis ir gėrimu.',
