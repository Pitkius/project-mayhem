...
Config.Jobs = {
    police = {
        ...
        kitStateKey = 'ltPdKit',
        serverEvent = 'fivempro_ltpd:server:setPdEmergencyMode',
        kitServerEvent = 'fivempro_ltpd:server:setPdEmergencyKit',
        clearOnExitEvent = 'fivempro_ltpd:server:clearPdEmergencyOnExit',
    ...
    ambulance = {
        ...
        serverEvent = 'fivempro_siren:server:setEmsEmergencyMode',
        kitServerEvent = 'fivempro_siren:server:setEmsEmergencyKit',
        clearOnExitEvent = 'fivempro_siren:server:clearEmsEmergencyOnExit',
        useLtpdPerms = false,
    },
}
