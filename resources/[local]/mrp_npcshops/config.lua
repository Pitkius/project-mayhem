...
Config.JunkShop = {
    ...
    items = {
        ...
        { name = 'gloves', amount = 250, price = 14, slot = 9 },
        { name = 'trimming_scissors', amount = 80, price = 68, slot = 10 },
        { name = 'scale', amount = 60, price = 120, slot = 11 },
        { name = 'empty_bag', amount = 300, price = 6, slot = 12 },
        { name = 'empty_bottle', amount = 500, price = 4, slot = 13 },
        { name = 'rope', amount = 120, price = 85, slot = 14 },
    },
}
