...
local function logAdmin(action, src, citizenid, details)
    ...
    print(('[fivempro_phone:bank] %s | src=%s cid=%s name=%s | %s'):format(
...
function Bank.Transfer(src, data)
    ...
    if recipient.source then
        ...
        TriggerClientEvent('fivempro_phone:client:refreshData', recipient.source)
    end
...
QBCore.Functions.CreateCallback('fivempro_phone:server:bankLookupRecipient', function(source, cb, data)
    cb(Bank.LookupRecipient(source, data and data.query))
end)

QBCore.Functions.CreateCallback('fivempro_phone:server:bankTransfer', function(source, cb, data)
...
QBCore.Functions.CreateCallback('fivempro_phone:server:bankDeposit', function(source, cb, data)
...
QBCore.Functions.CreateCallback('fivempro_phone:server:bankWithdraw', function(source, cb, data)
...
QBCore.Functions.CreateCallback('fivempro_phone:server:bankGetHistory', function(source, cb, data)
