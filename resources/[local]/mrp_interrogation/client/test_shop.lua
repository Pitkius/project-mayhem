...
local function openTestShopMenu()
    ...
    exports['qb-menu']:openMenu({
        ...
        { header = 'Pirkti 1 vnt.', params = { event = 'mrp_interrogation:client:buyTestKit' } },
        { header = 'Uždaryti', params = { isAction = true, event = function() exports['qb-menu']:closeMenu() end } },
    })
end

RegisterNetEvent('mrp_interrogation:client:buyTestKit', function()
    TriggerServerEvent('mrp_interrogation:server:buyTestKit')
end)
