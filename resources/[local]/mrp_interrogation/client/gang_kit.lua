            ...
            exports['qb-target']:AddTargetEntity(box, {
                options = {
                    ...
                    },
                    {
                        ...
                        action = function()
                            TriggerServerEvent('mrp_interrogation:server:pickupKit', id)
                        end,
                    },
                },
                distance = 2.4,
...
RegisterNetEvent('mrp_interrogation:client:syncKits', function(list)
...
RegisterNetEvent('mrp_interrogation:client:startPlaceKit', function()
    ...
    CreateThread(function()
        ...
        while placing do
            ...
            elseif IsControlJustPressed(0, 38) then
                ...
                placing = false
                TriggerServerEvent('mrp_interrogation:server:placeKit', fc.x, fc.y, fc.z, fh)
            end
        end
